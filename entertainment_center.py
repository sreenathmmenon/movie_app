...
shrek = Movie('shrek',
              trailers.get('shrek'))
snow_white = Movie('snow white and the seven dwarfs',
                   trailers.get('snow_white'))
zootopia = Movie('zootopia',
                 trailers.get('zootopia'))
pinocchio = Movie('pinocchio',
                  trailers.get('pinocchio'))
toystory3 = Movie('toy story 3',
                  trailers.get('toystory3'))
incredibles = Movie('the incredibles',
                    trailers.get('incredibles'))
dragon = Movie('how to train your dragon',
               trailers.get('dragon'))

# Create a list of all movie objects
movies = [toystory3, dragon, zootopia, incredibles, shrek, avatar,
          snow_white, moana, pinocchio]
